...
<table width="550" border="0" align="center" cellpadding="10" cellspacing="0">
    <tr> 
        <td>ขั้นตอนที่ 2 จาก 3 : ยืนยันการสั่งซื้อสินค้า </td>
    </tr>
</table>
...
?>
    <table width="550" border="0" align="center" cellpadding="5" cellspacing="1" class="infoTable">
        <tr class="infoTableHeader"> 
            <td colspan="3">รายการสั่งสินค้า</td>
        </tr>
        <tr class="label"> 
            <td>รายการ</td>
            <td>ราคา</td>
...
?>
    ...
    <table width="550" border="0" align="center" cellpadding="5" cellspacing="1" class="infoTable">
        <tr class="infoTableHeader"> 
            <td colspan="2">ข้อมูลของผู้ชำระสินค้า</td>
        </tr>
        <tr> 
            <td width="150" class="label">ชื่อ</td>
    ...
    <table width="550" border="0" align="center" cellpadding="5" cellspacing="1" class="infoTable">
      <tr>
        <td width="150" class="infoTableHeader">วิธีชำระเงิน </td>
        <td class="content"><?php echo $_POST['optPayment'] == 'paypal' ? 'ชำระผ่าน Paypal' : 'โอนเงินผ่านธนาคาร'; ?>
          <input name="hidPaymentMethod" type="hidden" id="hidPaymentMethod" value="<?php echo $_POST['optPayment']; ?>" />
        </tr>
    </table>
    <p>&nbsp;</p>
    <p align="center"> 
        <input name="btnBack" type="button" id="btnBack" value="&lt;&lt; แก้ไข้ข้อมูลการจัดสั่งสินค้า / ชำระเงิน" onClick="window.location.href='checkout.php?step=1';" class="box">
        &nbsp;&nbsp; 
        <input name="btnConfirm" type="submit" id="btnConfirm" value="ยืนยันการสั่งสินค้า &gt;&gt;" class="box">
</form>
<p>&nbsp;</p>
