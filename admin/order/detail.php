...
?>
<p>&nbsp;</p>
<form action="index.php" method="get" name="frmOrder" id="frmOrder">
    <input type="hidden" name="oid" value="<?php echo $orderId; ?>">
    <input type="hidden" name="view" value="modify">
    <table width="550" border="0"  align="center" cellpadding="5" cellspacing="1" class="detailTable">
        ...
        <tr> 
            ...
            <td class="content"> <select name="status" id="cboOrderStatus" class="box">
                    <?php echo $orderOption; ?> </select> <input name="btnModify" type="submit" id="btnModify" value="Modify Status" class="box"></td>
        </tr>
    </table>
</form>
<p>&nbsp;</p>
