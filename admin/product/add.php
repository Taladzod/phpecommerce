...
?>	 
  ...
  <tr> 
   ...
   <td class="content"><input name="txtWholesale" type="text" id="txtWholesale" size="10" maxlength="7" class="box" onKeyUp="checkNumber(this);"> </td>
  </tr>
  <tr> 
   <td width="150" class="label">Pv</td>
   <td class="content"><input name="txtPv" type="text" id="txtPv" size="10" maxlength="7" class="box" onKeyUp="checkNumber(this);"> </td>
  </tr>
  <tr> 
