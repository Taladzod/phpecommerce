...
function addProduct()
{
	...
	$wholesale	 = str_replace(',', '', (double)$_POST['txtWholesale']);
	$pv			 = str_replace(',', '', (double)$_POST['txtPv']);
	...
	$sql   = "INSERT INTO tbl_product (cat_id, pd_name, pd_description, pd_price, pd_qty, pd_image, pd_thumbnail, pd_date, pd_wholesale, pd_pv)
	          VALUES ('$catId', '$name', '$description', $price, $qty, '$mainImage', '$thumbnail', NOW(), $wholesale, $pv)";
...
function modifyProduct()
{
	...
	$sql   = "UPDATE tbl_product 
	          SET cat_id = $catId, pd_name = '$name', pd_description = '$description', pd_price = $price, 
			      pd_qty = $qty, pd_image = $mainImage, pd_thumbnail = $thumbnail, pd_wholesale = '$wholesale', pd_pv = $pv
